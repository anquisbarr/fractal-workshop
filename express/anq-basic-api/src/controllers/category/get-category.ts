...
import { parseCategoryIdFromRequest, parsePaginationFromRequest } from "@utils/parse-from-request";
import type { Request, Response } from "express";
import type { WithCategoryId } from "types/common";

export default async function getCategoryController(req: WithCategoryId<Request>, res: Response) {
  try {
