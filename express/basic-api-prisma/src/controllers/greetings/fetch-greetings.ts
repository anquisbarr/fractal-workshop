...
import { parseEmailFromRequest, parsePaginationFromQuery } from "../../utils/parse-from-request";

export default async function fetchGreetingsController(req: WithUser<Request>, res: Response) {
  try {
